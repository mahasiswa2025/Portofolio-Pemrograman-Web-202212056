...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($id <= 0) {
        ...
        if ($stmt) {
            ...
            $error = "Gagal mempersiapkan query pembaruan: " . $conn->error;
        }
    }
}
...
if ($id > 0) {
    // Menggunakan Prepared Statement untuk mengambil data lama
...
<head>
    ...
    <title>Edit Produk - STITEK Store Admin</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="form-container">
            <div class="card-premium">
                <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-4">
                    <h2 class="h4 mb-0 text-dark fw-bold">Edit Produk</h2>
                ...
                <form action="edit.php" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="harga" name="harga" required min="0" 
                                   value="<?php echo $row['harga']; ?>" placeholder="0">
                            <div class="invalid-feedback">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control" id="stok" name="stok" required min="0" 
                               value="<?php echo $row['stok']; ?>" placeholder="0">
                        <div class="invalid-feedback">
                    ...
                    <div class="d-grid mt-4 pt-2">
                        <button type="submit" class="btn btn-premium-primary py-2.5">
                            <i class="bi bi-check2-circle me-2"></i> Update Produk
                        </button>
                    </div>
                </form>
            </div>
